                ...
                <div className="navbar-nav me-lg-2">
                    <div className="nav-item text-nowrap d-flex align-items-center">
                                ...
                                <div className="container">
                                    <div className="row">
                                        <div className="col-lg-4 col-md-4 col-4">
                                            ...
                                            >
                                                <img
                                                    src="./src/assets/images/social/search.png"
                                        ...
                                        <div className="col-lg-4 col-md-4 col-4">
                                            ...
                                            >
                                                <img
                                                    src="./src/assets/images/social/spotify.png"
                                                    className="profile-image img-fluid"
                                                    alt=""
                                                />
                                                <span className="d-block">
                                        ...
                                        <div className="col-lg-4 col-md-4 col-4">
                                            ...
                                            >
                                                <img
                                                    src="./src/assets/images/social/telegram.png"
                                                    className="profile-image img-fluid"
                                                    alt=""
                                                />
                                                <span className="d-block">
                                        ...
                                        <div className="col-lg-4 col-md-4 col-4">
                                            ...
                                            >
                                                <img
                                                    src="./src/assets/images/social/snapchat.png"
                                                    className="profile-image img-fluid"
                                                    alt=""
                                                />
                                                <span className="d-block">
                                        ...
                                        <div className="col-lg-4 col-md-4 col-4">
                                            ...
                                            >
                                                <img
                                                    src="./src/assets/images/social/tiktok.png"
                                                    className="profile-image img-fluid"
                                                    alt=""
                                                />
                                                <span className="d-block">
                                        ...
                                        <div className="col-lg-4 col-md-4 col-4">
                                            ...
                                            >
                                                <img
                                                    src="./src/assets/images/social/youtube.png"
                                                    className="profile-image img-fluid"
                                                    alt=""
                                                />
                                                <span className="d-block">
                        ...
                        <div className="dropdown px-3">
                            ...
                            >
                                <img
                                    src="./src/assets/images/medium-shot-happy-man-smiling.jpg"
                                    className="profile-image img-fluid"
                                    alt=""
                                />
                            </a>
